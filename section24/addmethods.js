// var person = {
//     firstname :"paulwalker",
//     lastname :"vindiesel",
//     type :"hollywood",
//     get details(){
//         return (this.firstname+ " and "+ this.lastname+ " belongs to "+this.type)
//     }
// // }

// // console.log(person.details) //here i dont need parathesis beside the function calling because this 
// // //i have used the getter meethod over here 
...
console.log(person["children"][0]["firstname"])
console.log(person.children[0].firstname) //either ways you can get the value